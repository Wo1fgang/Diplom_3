...
from locators.recover_password_locators import RECOVER_PASSWORD_TEXT_AFTER_REDIRECT, \
    ACTIVE_RECOVER_PASSWORD_PAGE_PASSWORD_INPUT
...
class TestRecoverPasswordPage:
    ...
    def test_enter_email_click_recover(self, driver):
        ...
        assert browser.get_current_url() == f'{BASE_URL}{RESET_PASSWORD_PAGE}' and browser.find_element(RECOVER_PASSWORD_TEXT_AFTER_REDIRECT)
    ...
    def test_show_hide_password(self, driver):
        ...
        assert browser.find_element(ACTIVE_RECOVER_PASSWORD_PAGE_PASSWORD_INPUT)